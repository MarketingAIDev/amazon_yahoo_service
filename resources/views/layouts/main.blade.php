			...
			<div class="layout-container">
				...
				<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
					...
					<ul class="menu-inner py-1">
						...
						<li <?php if (strpos(url()->current(), "item/add")) echo 'class="menu-item active open"';
								else echo 'class="menu-item"'; ?>>
						...
						<li <?php if (strpos(url()->current(), "item/list")) echo 'class="menu-item active open"';
								else echo 'class="menu-item"'; ?>>
							<a href="javascript:void(0);" class="menu-link menu-toggle">
						...
						<li <?php if (strpos(url()->current(), "category")) echo 'class="menu-item active"';
								else echo 'class="menu-item"'; ?>>
